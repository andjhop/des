...
TEXT ·e(SB),NOSPLIT,$16
	MOVQ ·in(FP), X0
	CALL eVec2(SB)
	MOVQ X0, ·ret+8(FP)
	RET

TEXT ·eVec2(SB),NOSPLIT,$32
	VMOVDQU ·in(FP), X0
	CALL    eVec2(SB)
	VMOVDQU X0, ·ret+16(FP)
	RET

TEXT eVec2(SB),NOSPLIT|NOFRAME,$0
	VPXOR X1, X1, X1

	MOVQ $1, BX
	MOVQ $0x000000000000001f, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $3, BX
	MOVQ $0x00000000000001f8, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $5, BX
	MOVQ $0x0000000000001f80, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $7, BX
	MOVQ $0x000000000001f800, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $9, BX
	MOVQ $0x00000000001f8000, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $11, BX
	MOVQ $0x0000000001f80000, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $13, BX
	MOVQ $0x000000001f800000, AX
	CALL bitGroupLeftShiftVec2(SB)

	MOVQ $15, BX
	MOVQ $0x00000000f8000000, AX
	CALL bitGroupLeftShiftVec2(SB)
...
TEXT ·p(SB),NOSPLIT,$16
	MOVQ ·in(FP), X0
	CALL pq(SB)
	MOVQ X0, ·ret+8(FP)
	RET

TEXT ·pVec2(SB),NOSPLIT,$32
	VMOVDQU ·in(FP), X0
	CALL    pVec2(SB)
	VMOVDQU X0, ·ret+16(FP)
	RET

TEXT pVec2(SB),NOSPLIT|NOFRAME,$0
	VPXOR X1, X1, X1
	...
	MOVQ $32, CX
	MOVQ $4, BX
	MOVQ $0x000000000004000, AX
	CALL bitGroupLeftRotateVec2(SB)
	
	MOVQ $32, CX
	MOVQ $5, BX
	MOVQ $0x0000000012020120, AX
	CALL bitGroupLeftRotateVec2(SB)
	...
	MOVQ $32, CX
	MOVQ $14, BX
	MOVQ $0x0000000000000040, AX
	CALL bitGroupLeftRotateVec2(SB)

	MOVQ $32, CX
	MOVQ $15, BX
	MOVQ $0x0000000000010000, AX
	CALL bitGroupLeftRotateVec2(SB)
	...
	MOVQ $32, CX
	MOVQ $17, BX
	MOVQ $0x0000000040801800, AX
	CALL bitGroupLeftRotateVec2(SB)

	MOVQ $32, CX
	MOVQ $19, BX
	MOVQ $0x0000000000080000, AX
	CALL bitGroupLeftRotateVec2(SB)
	...
	MOVQ $32, CX
	MOVQ $24, BX
	MOVQ $0x0000000088000008, AX
	CALL bitGroupLeftRotateVec2(SB)

	MOVQ $32, CX
	MOVQ $25, BX
	MOVQ $0x0000000000000480, AX
	CALL bitGroupLeftRotateVec2(SB)

	MOVQ $32, CX
	MOVQ $26, BX
	MOVQ $0x0000000000442000, AX
	CALL bitGroupLeftRotateVec2(SB)
