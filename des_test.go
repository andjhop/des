...
func testDESEncryptBlocks(tests cryptTests) func(*testing.T) {
	mode := NewDESECBEncrypter(tests.key[:])
	return func(t *testing.T) {
		out := make([]byte, len(tests.out))
		mode.CryptBlocks(out, tests.in)
...
func TestDESCryptBlocks(t *testing.T) {
	t.Run("sample outputs", testDESEncryptBlocks(testsSample))
	t.Run("known answer tests table 1", testDESEncryptBlocks(testsTable1))
}
